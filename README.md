...
Deployed Application (*required*): [https://kudos-board-1-zmwy.onrender.com/]
...
Yes, the labs working woth PostgreSQL were essential to completing this assignment. I was able to use the knowledge I gained from the labs to create the database and the models.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

I am very happy with how it came out, additional features could have been cool. Maybe if I did a delete and/or edit comment feature.
